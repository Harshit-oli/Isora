...
const EditProfile = () => {
    ...
    const [frontendImage,setFrontendImage]=useState(userData.profileImage || logo2);
  ...
  return (
    <div className='w-full min-h-[100vh] bg-black flex items-center flex-col gap-[20px] '>
      ...
      <div className='w-[80px] h-[80px] border-2 border-black rounded-full cursor-pointer overflow-hidden md:w-[100px] h-[100px]' onClick={()=>imageInput.current.click()}>
      ...
      <div className='text-blue-500 text-center text-[18px] font-semibold cursor-pointer' onClick={()=>imageInput.current.click()}>Change Your Profile Picture</div>
       ...
       <input type="text" className='w-[90%] max-w-[600px] h-[60px] bg-[#0a1010] border-2 border-gray-700 text-white font-semibold rounded-2xl px-[20px] outline-none'
       ...
       <button className='px-[10px] w-[60%] max-w-[400px] py-[5px] h-[50px] bg-[white] cursor-pointer rounded-2xl font-semibold' onClick={handleEditProfile}>{loading?<ClipLoader size={30} color='black'/>:"Save Profile"}</button>
